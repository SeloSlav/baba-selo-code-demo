...
export const ChatWindow = forwardRef(({ isSidebarOpen }: ChatWindowProps, ref) => {
    ...
    useEffect(() => {
        if (typeof window !== "undefined" && "visualViewport" in window && windowWidth !== null && windowWidth < 768) {
    ...
    return (
        <div className="flex flex-col h-screen w-full">
            ...
            <div
                className={`w-full max-w-2xl mx-auto px-4 md:px-0 ${windowWidth !== null && windowWidth < 768 ? "fixed bottom-0 left-0" : "relative md:static"
                    }`}
                style={{
                    zIndex: 10,

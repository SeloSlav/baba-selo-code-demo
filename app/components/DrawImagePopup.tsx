      ...
      <div className="bg-white rounded-2xl w-full max-w-lg p-6 shadow-xl border border-amber-100">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-amber-100 rounded-xl">
              <FontAwesomeIcon icon={faMagicWandSparkles} className="text-xl text-amber-700" />
            </div>
            <div>
        ...
        <div className="mb-6">
          <textarea
            ...
            className="w-full h-32 p-4 border border-amber-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-400 resize-none"
          />
